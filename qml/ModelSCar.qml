...
Node {
    ...
    // SURGICAL Side Repeaters - Black when off, bright orange when on
    ...
    Node {
        ...
        // PHYSICAL Side Repeaters (the Tesla camera badge housings on fenders)
        ...
        // Repeater Rays originating from the physical camera pieces
        ...
        // --- Real SpotLights ---
        SpotLight { position: Qt.vector3d(482, 120, -180); eulerRotation: Qt.vector3d(0, -90, 0); brightness: getVal(0)*10000; coneAngle: 30; color: "white"; castsShadow: true }
        SpotLight { position: Qt.vector3d(482, 120, 180); eulerRotation: Qt.vector3d(0, -90, 0); brightness: getVal(1)*10000; coneAngle: 30; color: "white"; castsShadow: true }
        ...
        // Front Fog Light Glow
        PointLight { position: Qt.vector3d(450, 50, -180); brightness: getVal(14)*3000; color: "white" }
        PointLight { position: Qt.vector3d(450, 50, 180); brightness: getVal(15)*3000; color: "white" }

        // Side Repeater Glow
        PointLight { position: Qt.vector3d(255, 155, -195); brightness: getVal(20)*400; color: "orange" }
        PointLight { position: Qt.vector3d(255, 155, 195); brightness: getVal(21)*400; color: "orange" }
    ...
    readonly property var markerModel: [
        ...
        { ch: 4, pos: Qt.vector3d(480, 150, -150), c: "cyan" }, { ch: 5, pos: Qt.vector3d(480, 150, 150), c: "cyan" },
        { ch: 12, pos: Qt.vector3d(480, 150, -210), c: "orange" }, { ch: 13, pos: Qt.vector3d(480, 150, 210), c: "orange" },
        { ch: 14, pos: Qt.vector3d(450, 50, -180), c: "white" }, { ch: 15, pos: Qt.vector3d(450, 50, 180), c: "white" },
